...
- [CORE Economics](https://www.core-econ.org/){:target="_blank"}
  - **Micro** — material [here](https://github.com/woomora/CORE-econ-micro){:target="_blank"}
  - **Macro** — material [here](https://github.com/woomora/CORE-econ-macro){:target="_blank"}
- **Microeconomics II** — material [here](https://github.com/woomora/psl-micro-II){:target="_blank"}
